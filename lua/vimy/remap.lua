...
-- Manage sessions
vim.keymap.set("n", "<C-S-s>", ":mksession! ~/.config/nvim/session/_root_.vim<CR>")
vim.keymap.set("n", "<C-S-d>", ":!rm ~/.config/nvim/session/_root_.vim<CR>")
vim.keymap.set("n", "<C-l>", ":source ~/.config/nvim/session/_root_.vim<CR>")
